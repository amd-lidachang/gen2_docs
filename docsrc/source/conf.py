...
release = '5.1'
html_last_updated_fmt = 'April 17, 2025'


# -- General configuration ---------------------------------------------------

html_baseurl = os.environ.get("READTHEDOCS_CANONICAL_URL", "https://vitisai.docs.amd.com/projects/internal")
html_context = {}
...
breathe_default_project = "vitis_ai"
...
edit_on_github_project = 'AMD-AI/vitis-ai-documentation-internal'
edit_on_github_branch = 'main/docsrc/source'
...
latex_documents = [
    (master_doc, 'vitisai.tex', 'Vitis AI',
     'AMD', 'manual'),
]
...
#################################################################################
#License
#Vitis AI is licensed under `MIT License <https://github.com/amd/ryzen-ai-documentation/blob/main/License>`_ . Refer to the `LICENSE File <https://github.com/amd/ryzen-ai-documentation/blob/main/License>`_ for the full license text and copyright notice.
